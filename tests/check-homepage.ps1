...
$requirements = @(
    ...
    @{ Pattern = '异构FPGA开发'; Description = 'the heterogeneous FPGA development stack card' }
    @{ Pattern = '嵌入式开发'; Description = 'the embedded development stack card' }
    @{ Pattern = '数字 IC 设计与验证'; Description = 'the digital IC design and verification stack card' }
    @{ Pattern = 'PCB 设计'; Description = 'the PCB design stack card' }
